...
/**
 * Provides the local service interface for Billing_PO. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Billing_POLocalServiceUtil
...
public interface Billing_POLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Billing_POLocalServiceUtil} to access the billing_ p o local service. Add custom service methods to {@link com.sphms.common.service.service.impl.Billing_POLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public JSONObject getBillingPOListForReport(long customComanyId,
		long landLoardId, Date startDate, Date endDate, int start, int end)
	...
	*/
	...
	public Billing_PO addBillingPO(long billingId, long hordingId,
		double totalAmount, long createdBy, CustomCompany company);
	...
	*/
	...
	public Billing_PO addBilling_PO(Billing_PO billing_PO);
	...
	*/
	public Billing_PO createBilling_PO(Billing_POPK billing_POPK);
	...
	*/
	...
	public Billing_PO deleteBilling_PO(Billing_PO billing_PO);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Billing_PO deleteBilling_PO(Billing_POPK billing_POPK)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Billing_PO fetchBilling_PO(Billing_POPK billing_POPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Billing_PO getBilling_PO(Billing_POPK billing_POPK)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public java.lang.String getPONumber(Billing_PO billingPO,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Billing_PO> getBilling_POByBillingIdAndLandLordId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Billing_PO> getBilling_POs(int start, int end);
