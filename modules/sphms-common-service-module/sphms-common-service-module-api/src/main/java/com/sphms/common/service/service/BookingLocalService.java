...
public interface BookingLocalService extends BaseLocalService,
	...
	*/
	...
	public Booking addBooking(java.lang.String campaignTitle, long client,
		long companyId, Date startDate, Date endDate,
		List<Booking_HordingBean> bookingHordingList, long createdBy,
	...
	*/
	...
	public Booking updateBooking(long bookingId,
		...
		List<Booking_HordingBean> bookingHordingList, long modifiedBy)
		throws PortalException;
