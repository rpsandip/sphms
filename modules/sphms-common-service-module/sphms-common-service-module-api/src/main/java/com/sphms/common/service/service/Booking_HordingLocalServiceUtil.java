...
/**
 * Provides the local service utility for Booking_Hording. This utility wraps
 * {@link com.sphms.common.service.service.impl.Booking_HordingLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class Booking_HordingLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.sphms.common.service.service.impl.Booking_HordingLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.sphms.common.service.model.Booking_Hording addBooking_Hording(
		com.sphms.common.service.model.Booking_Hording booking_Hording) {
		return getService().addBooking_Hording(booking_Hording);
	}
	...
	*/
	public static com.sphms.common.service.model.Booking_Hording createBooking_Hording(
		com.sphms.common.service.service.persistence.Booking_HordingPK booking_HordingPK) {
		return getService().createBooking_Hording(booking_HordingPK);
	}
	...
	*/
	public static com.sphms.common.service.model.Booking_Hording deleteBooking_Hording(
		com.sphms.common.service.model.Booking_Hording booking_Hording) {
		return getService().deleteBooking_Hording(booking_Hording);
	}
	...
	*/
	public static com.sphms.common.service.model.Booking_Hording deleteBooking_Hording(
		com.sphms.common.service.service.persistence.Booking_HordingPK booking_HordingPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteBooking_Hording(booking_HordingPK);
	}

	public static com.sphms.common.service.model.Booking_Hording fetchBooking_Hording(
		com.sphms.common.service.service.persistence.Booking_HordingPK booking_HordingPK) {
		return getService().fetchBooking_Hording(booking_HordingPK);
	}
	...
	* @throws PortalException if a booking_ hording with the primary key could not be found
	*/
	public static com.sphms.common.service.model.Booking_Hording getBooking_Hording(
		com.sphms.common.service.service.persistence.Booking_HordingPK booking_HordingPK)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getBooking_Hording(booking_HordingPK);
	}
	...
	*/
	public static com.sphms.common.service.model.Booking_Hording updateBooking_Hording(
		com.sphms.common.service.model.Booking_Hording booking_Hording) {
		return getService().updateBooking_Hording(booking_Hording);
	}
	...
	*/
	public static int getBooking_HordingsCount() {
		return getService().getBooking_HordingsCount();
	}
	...
	*/
	...
	public static java.util.List<com.sphms.common.service.model.Booking_Hording> getBookingHordingsList(
		long bookingId) {
		return getService().getBookingHordingsList(bookingId);
	}
	...
	*/
	public static java.util.List<com.sphms.common.service.model.Booking_Hording> getBooking_Hordings(
		int start, int end) {
		return getService().getBooking_Hordings(start, end);
	}
	...
	*/
	...
	public static Booking_HordingLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<Booking_HordingLocalService, Booking_HordingLocalService> _serviceTracker =
		ServiceTrackerFactory.open(Booking_HordingLocalService.class);
}