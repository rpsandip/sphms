...
/**
 * Provides the local service interface for CreditNote. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreditNoteLocalServiceUtil
...
public interface CreditNoteLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CreditNoteLocalServiceUtil} to access the credit note local service. Add custom service methods to {@link com.sphms.common.service.service.impl.CreditNoteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public CreditNote createCreditNote(long creditNoteId);
	...
	*/
	...
	public CreditNote deleteCreditNote(CreditNote creditNote);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CreditNote deleteCreditNote(long creditNoteId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CreditNote fetchCreditNote(long creditNoteId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CreditNote> getCreditNotes(int start, int end);
