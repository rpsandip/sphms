...
/**
 * Provides the local service interface for CustomCompany. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CustomCompanyLocalServiceUtil
...
public interface CustomCompanyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomCompanyLocalServiceUtil} to access the custom company local service. Add custom service methods to {@link com.sphms.common.service.service.impl.CustomCompanyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CustomCompany addCustomCompany(CustomCompany customCompany);
	...
	*/
	public CustomCompany createCustomCompany(long companyId);
	...
	*/
	...
	public CustomCompany deleteCustomCompany(CustomCompany customCompany);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CustomCompany deleteCustomCompany(long companyId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomCompany fetchCustomCompany(long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CustomCompany getCustomCompany(long companyId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CustomCompany updateCustomCompany(CustomCompany customCompany);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CustomCompany> getCustomCompanies(int start, int end);
