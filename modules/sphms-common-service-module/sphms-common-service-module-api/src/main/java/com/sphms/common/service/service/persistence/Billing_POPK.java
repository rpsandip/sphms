 ...
 */
@ProviderType
public class Billing_POPK implements Comparable<Billing_POPK>, Serializable {
	...
	public Billing_POPK(long billingId, long hordingId) {
	...
	@Override
	public int compareTo(Billing_POPK pk) {
		if (pk == null) {
			return -1;
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof Billing_POPK)) {
			return false;
		}

		Billing_POPK pk = (Billing_POPK)obj;
