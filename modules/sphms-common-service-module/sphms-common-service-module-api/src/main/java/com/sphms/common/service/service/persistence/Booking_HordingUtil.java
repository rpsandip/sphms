...
/**
 * The persistence utility for the booking_ hording service. This utility wraps {@link com.sphms.common.service.service.persistence.impl.Booking_HordingPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class Booking_HordingUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(Booking_Hording booking_Hording) {
		getPersistence().clearCache(booking_Hording);
	}
	 ...
	 */
	public static List<Booking_Hording> findWithDynamicQuery(
	 ...
	 */
	public static Booking_Hording update(Booking_Hording booking_Hording) {
		return getPersistence().update(booking_Hording);
	}
	...
	public static Booking_Hording update(Booking_Hording booking_Hording,
		...
		return getPersistence().update(booking_Hording, serviceContext);
	}
	...
	*/
	public static List<Booking_Hording> findBybookingId(long bookingId) {
	...
	*/
	public static List<Booking_Hording> findBybookingId(long bookingId,
		int start, int end, OrderByComparator<Booking_Hording> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Booking_Hording findBybookingId_First(long bookingId,
		OrderByComparator<Booking_Hording> orderByComparator)
		throws com.sphms.common.service.exception.NoSuchBooking_HordingException {
		return getPersistence()
	...
	*/
	public static Booking_Hording fetchBybookingId_First(long bookingId,
		OrderByComparator<Booking_Hording> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchBooking_HordingException if a matching booking_ hording could not be found
	*/
	public static Booking_Hording findBybookingId_Last(long bookingId,
		OrderByComparator<Booking_Hording> orderByComparator)
		throws com.sphms.common.service.exception.NoSuchBooking_HordingException {
		return getPersistence()
	...
	*/
	public static Booking_Hording fetchBybookingId_Last(long bookingId,
		OrderByComparator<Booking_Hording> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Booking_Hording[] findBybookingId_PrevAndNext(
		Booking_HordingPK booking_HordingPK, long bookingId,
		OrderByComparator<Booking_Hording> orderByComparator)
		throws com.sphms.common.service.exception.NoSuchBooking_HordingException {
		return getPersistence()
				   .findBybookingId_PrevAndNext(booking_HordingPK, bookingId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(Booking_Hording booking_Hording) {
		getPersistence().cacheResult(booking_Hording);
	}
	...
	*/
	public static void cacheResult(List<Booking_Hording> booking_Hordings) {
		getPersistence().cacheResult(booking_Hordings);
	}
	...
	*/
	public static Booking_Hording create(Booking_HordingPK booking_HordingPK) {
		return getPersistence().create(booking_HordingPK);
	}
	...
	* @throws NoSuchBooking_HordingException if a booking_ hording with the primary key could not be found
	*/
	public static Booking_Hording remove(Booking_HordingPK booking_HordingPK)
		throws com.sphms.common.service.exception.NoSuchBooking_HordingException {
		return getPersistence().remove(booking_HordingPK);
	}

	public static Booking_Hording updateImpl(Booking_Hording booking_Hording) {
		return getPersistence().updateImpl(booking_Hording);
	}
	...
	* @throws NoSuchBooking_HordingException if a booking_ hording with the primary key could not be found
	*/
	public static Booking_Hording findByPrimaryKey(
		Booking_HordingPK booking_HordingPK)
		throws com.sphms.common.service.exception.NoSuchBooking_HordingException {
		return getPersistence().findByPrimaryKey(booking_HordingPK);
	}
	...
	*/
	public static Booking_Hording fetchByPrimaryKey(
		Booking_HordingPK booking_HordingPK) {
		return getPersistence().fetchByPrimaryKey(booking_HordingPK);
	}

	public static java.util.Map<java.io.Serializable, Booking_Hording> fetchByPrimaryKeys(
	...
	*/
	public static List<Booking_Hording> findAll() {
	...
	*/
	public static List<Booking_Hording> findAll(int start, int end) {
	...
	*/
	...
	public static Booking_HordingPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<Booking_HordingPersistence, Booking_HordingPersistence> _serviceTracker =
		ServiceTrackerFactory.open(Booking_HordingPersistence.class);
}