...
/**
 * The persistence utility for the payment service. This utility wraps {@link com.sphms.common.service.service.persistence.impl.PaymentPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PaymentUtil {
	...
	*/
	public static List<Payment> findBybillingId(long billingId) {
	...
	*/
	public static List<Payment> findBybillingId(long billingId, int start,
		int end) {
	...
	*/
	public static List<Payment> findBybillingId(long billingId, int start,
		int end, OrderByComparator<Payment> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Payment findBybillingId_First(long billingId,
		OrderByComparator<Payment> orderByComparator)
		throws com.sphms.common.service.exception.NoSuchPaymentException {
		return getPersistence()
	...
	*/
	public static Payment fetchBybillingId_First(long billingId,
		OrderByComparator<Payment> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchPaymentException if a matching payment could not be found
	*/
	public static Payment findBybillingId_Last(long billingId,
		OrderByComparator<Payment> orderByComparator)
		throws com.sphms.common.service.exception.NoSuchPaymentException {
		return getPersistence()
	...
	*/
	public static Payment fetchBybillingId_Last(long billingId,
		OrderByComparator<Payment> orderByComparator) {
		return getPersistence()
	...
	*/
	public static Payment[] findBybillingId_PrevAndNext(long paymentId,
		long billingId, OrderByComparator<Payment> orderByComparator)
		throws com.sphms.common.service.exception.NoSuchPaymentException {
		return getPersistence()
				   .findBybillingId_PrevAndNext(paymentId, billingId,
			orderByComparator);
	}
	...
	*/
	...
	public static java.util.Map<java.io.Serializable, Payment> fetchByPrimaryKeys(
	...
	*/
	...
	private static ServiceTracker<PaymentPersistence, PaymentPersistence> _serviceTracker =
		ServiceTrackerFactory.open(PaymentPersistence.class);
}